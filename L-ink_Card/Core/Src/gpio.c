...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, LED_Pin|ST25_LPD_Pin|INK_MOSI_Pin|INK_CLK_Pin
  ...
  /*Configure GPIO pins : PAPin PAPin PAPin PAPin
                           PAPin */
  GPIO_InitStruct.Pin = LED_Pin|ST25_LPD_Pin|INK_MOSI_Pin|INK_CLK_Pin
                          |INK_CS_Pin;
  ...
  /*Configure GPIO pin : PtPin */
  GPIO_InitStruct.Pin = INK_IS_BUSY_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(INK_IS_BUSY_GPIO_Port, &GPIO_InitStruct);
